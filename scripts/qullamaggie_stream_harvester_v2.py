...
COMMON_BAD_TICKERS = {
    "I", "A", "AI", "TV", "US", "USA", "GDP", "CPI", "FED", "FOMC", "CEO", "IPO",
    "ATM", "IMO", "FYI", "FAQ", "USD", "EUR", "GBP", "CAD", "AUD", "JPY", "OTC",
    "SEC", "ETF", "ETFS", "EPS", "PE", "PNL", "RSI", "MACD", "DMA", "EMA", "SMA",
    "VWAP", "OR", "D", "W", "M", "T", "Y", "Q", "K", "OK", "LIVE", "NEWS", "LONG",
    "SHORT", "BID", "ASK", "LOL", "ATH", "ATL", "HOD", "LOD", "THE", "AND", "FOR",
    "NOT", "YES", "NO", "YOU", "WE", "HE", "SHE", "IT", "ARE", "WAS", "HIS", "HER",
    "THIS", "THAT",
}
...
def main() -> int:
    ...
    for idx, video in enumerate(videos, start=1):
        ...
        if args.save_all_transcripts:
            ...
            (outdir / "transcripts" / f"{stem}.json").write_text(
                json.dumps(tx, ensure_ascii=False, indent=2),
                encoding="utf-8",
            )
            (outdir / "transcripts" / f"{stem}.txt").write_text(
                transcript_to_text(tx),
                encoding="utf-8",
            )
